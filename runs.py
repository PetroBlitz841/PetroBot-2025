...
def green_run():
    ...
    wheels.straight(170)
    wheels.turn(53)
    wheels.straight(630, Stop.HOLD)
    # wheels.straight(-35, Stop.HOLD)
    right_arm.run_angle(700, 200)
    right_arm.run_angle(-700, 1310, Stop.HOLD)
    wheels.straight(-50)
    wheels.curve(-180, 110)
    wheels.straight(-300)
    wheels.straight(50)
    wheels.turn(25)
    wheels.straight(-100)
